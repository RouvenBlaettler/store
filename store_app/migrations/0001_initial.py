# Generated by Django 6.0.1 on 2026-01-11 14:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payement_status', models.CharField(choices=[('P', 'Pending'), ('C', 'Complete'), ('F', 'Failed')], default='P', max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('collection', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='store_app.collection')),
                ('promotions', models.ManyToManyField(to='store_app.promotion')),
            ],
        ),
        migrations.CreateModel(
            name='OrderItem',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='store_app.product'),
        ),
        migrations.CreateModel(
            name='CartItem',
            fields=[
